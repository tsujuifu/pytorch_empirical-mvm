...
def get_vidswin_model(args):
    if int(args.size_img) == 384 and args.vis_backbone_size == "large":
        ...
        if args.vis_backbone_init == "2d":
            model_path = f'./models/swin_transformer/swin_{backbone_size}_patch4_window12_384_22k.pth'
        else:
            model_path = './models/video_swin_transformer/swin_%s_384_patch244_window81212_kinetics%s_22k.pth' % (args.vis_backbone_size, args.kinetics)
        ...
        if args.vis_backbone_init == "2d":
            model_path = './models/swin_transformer/swin_%s_patch4_window7_224_22k.pth' % (args.vis_backbone_size)
        else:
            model_path = './models/video_swin_transformer/swin_%s_patch244_window877_kinetics%s_22k.pth' % (args.vis_backbone_size, args.kinetics)
        ...
        if args.vis_backbone_init == "2d":
            ...
            model_path = './models/video_swin_transformer/swin_tiny_patch244_window877_kinetics400_1k.pth'
    else:
